    ...
    public function run(): void
    {
        ...
        $places = [
            ...
            [
                ...
                'tags' => json_encode(['Street Food', 'Budget', 'Gulshan', 'Evening']),
                'is_published' => true,
                'created_by' => $admin->id,
            ],
            [
                ...
                'average_rating' => 4.3,
                'total_reviews' => 3200,
                'tags' => json_encode(['Shopping', 'Cinema & Screenings', 'Family', 'Ice Rink', 'Food Court']),
                'is_published' => true,
                'created_by' => $admin->id,
            ],
            [
            ...
            [
                ...
                'cover_image_url' => 'https://lh3.googleusercontent.com/gps-cs-s/APNQkAH-4IpoMQaXAdHduYF3jv1yOWdka3F4Rau7mcj9k_IoEfeZTqJPtQNU-6_AazbVHRBmi4eOy8OiywxHscwb3qBW_OLs5HGtcMWQfXTjdBZ7v_7hJD7zDjc-QMiR-T_ZOWWq7HSvvQWYrzIX=s680-w680-h510-rw',
                'budget_tier' => '$$$',
                'budget_label' => 'High',
            ...
            [
                ...
                'average_rating' => 4.3,
                'total_reviews' => 3200,
                'tags' => json_encode(['Super Mall', 'Theme Park', 'Bowling', 'Global Brands']),
                'is_published' => true,
                'created_by' => $admin->id,
            ],
            [
                ...
                'average_rating' => 4.2,
                'total_reviews' => 920,
                'tags' => json_encode(['Traditional', 'Bargain', 'Historic', 'Old School']),
                'is_published' => true,
                'created_by' => $admin->id,
            ],
        ];
